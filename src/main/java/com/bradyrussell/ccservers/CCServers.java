 ...
 * at com.bradyrussell.ccservers.network.CommonProxy.preInit(CommonProxy.java:25) ~[CommonProxy.class:?]
...
public class CCServers {
    ...
    @Mod.Instance(CCServers.MODID)
    public static CCServers instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide = "com.bradyrussell.ccservers.network.ClientOnlyProxy", serverSide = "com.bradyrussell.ccservers.network.DedicatedServerProxy")
     ...
     *
     * @param name
     * @return eg "ccservers:myblockname"
     */
